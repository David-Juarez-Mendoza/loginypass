package com.example.appfarmaciab.ConfiguracionBD;
        ...
        btnGuarda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!txtNombre.getText().toString().equals("") && !txtTelefono.getText().toString().equals("")) {
                    ...
                    if (id > 0) {
                        Toast.makeText(NuevoActivity.this, "FARMACIA GUARDADO", Toast.LENGTH_LONG).show();
                        limpiar();
                    } else {
                        Toast.makeText(NuevoActivity.this, "ERROR AL GUARDAR LA FARMACIA", Toast.LENGTH_LONG).show();
                    }
                } else {

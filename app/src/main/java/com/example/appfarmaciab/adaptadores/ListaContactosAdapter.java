package com.example.appfarmaciab.adaptadores;
...
import com.example.appfarmaciab.ConfiguracionBD.VerActivity;
...
public class ListaContactosAdapter extends RecyclerView.Adapter<ListaContactosAdapter.ContactoViewHolder> {
    ...
    {
        View view =
                LayoutInflater.from(parent.getContext()).inflate(R.layout.lista_item_contacto, null,
                        false);
        ...
        public ContactoViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra("ID",
                            listaContactos.get(getAdapterPosition()).getId());
